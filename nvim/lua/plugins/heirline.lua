return {
	...
	config = function()
		...
		-- Extract colors from your sonokai theme
		...
		local Git = {
			...
			},
			{
				...
				},
				{
					...
					hl = { fg = colors.git_add, bg = colors.diff_bg },
				},
				{
					provider = function(self)
					...
					hl = { fg = colors.git_change, bg = colors.diff_bg },
				},
				{
					provider = function(self)
					...
					hl = { fg = colors.git_del, bg = colors.diff_bg },
				},
				{
					provider = " ",
					hl = { bg = colors.diff_bg },
		...
		local Diagnostics = {
			...
			},
			{
				...
				hl = { fg = "#8e95b1", bg = colors.diag_bg },
			},
			{
				provider = function(self)
		...
		local StatusLine = {
			...
			update = { "ModeChanged", "CursorMoved", "CursorMovedI", "BufEnter", "BufLeave" },
		}
